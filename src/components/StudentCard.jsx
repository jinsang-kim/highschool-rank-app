...
import { ChevronRight, ArrowUp, ArrowDown, Minus, Sparkles, User, Award, Flame, School } from 'lucide-react';
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-start sm:items-center space-x-3.5 sm:space-x-5">
          ...
          {/* Student Info & Dynamic Tier Character */}
          <div className="space-y-1.5 flex-1">
            ...
            <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500">
              <span className="inline-flex items-center px-2 py-0.5 rounded-lg bg-pink-50 text-pink-700 border border-pink-100 font-semibold">
                <School className="w-3 h-3 mr-1 text-pink-500" />
                {grade}학년 {classNum}반
              </span>
        ...
        <div className="flex items-center justify-between md:justify-end space-x-4 pt-2 md:pt-0 border-t md:border-t-0 border-pink-100/60">
          ...
          <div className="flex flex-col items-start md:items-end w-full md:w-48">
            <div className="flex items-baseline space-x-1">
              <span className="text-xs text-slate-400 font-semibold">개인 총점</span>
