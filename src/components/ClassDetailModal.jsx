...
import { X, Sparkles, User, Award, Calendar, PlusCircle, MinusCircle, Heart, Trash2, School, Moon, Clock, Flame } from 'lucide-react';
...
export default function ClassDetailModal({
  ...
  const breakdown = calculateCategoryBreakdown(classItem);
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        >
          ...
          <div className="relative p-6 sm:p-7 bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 border-b border-pink-200/60">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-start sm:items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="mt-2 flex flex-wrap gap-1.5 text-xs">
                    ...
                    {representative && (
                      <span className="px-2 py-0.5 rounded-lg bg-white/80 font-semibold text-purple-700 border border-purple-200">
              ...
              <div className="flex sm:flex-col items-center sm:items-end justify-between bg-white/90 p-3.5 sm:p-4 rounded-2xl border border-pink-200/80 shadow-xs">
                <span className="text-xs font-bold text-slate-500">생활기록 총점</span>
          ...
          <div className="p-6 space-y-6 overflow-y-auto flex-1">
            ...
            {/* 4 Core Score Category Breakdown Badges */}
            <div>
              <h4 className="text-sm font-bold text-slate-700 mb-3 flex items-center">
                <Sparkles className="w-4 h-4 mr-1 text-pink-500" />
                4대 생활기록 점수 항목별 누적 분석
              </h4>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                ...
                <div className="p-3.5 rounded-2xl bg-purple-50/60 border border-purple-100 flex flex-col justify-between">
                  ...
                  <div className={`text-lg font-black mt-2 ${breakdown['야자점수'] >= 0 ? 'text-purple-900' : 'text-rose-600'}`}>
                ...
                <div className="p-3.5 rounded-2xl bg-amber-50/60 border border-amber-100 flex flex-col justify-between">
                  ...
                  <div className={`text-lg font-black mt-2 ${breakdown['지각및복장점수'] >= 0 ? 'text-amber-900' : 'text-rose-600'}`}>
                    {breakdown['지각및복장점수'] > 0 ? `+${breakdown['지각및복장점수']}` : breakdown['지각및복장점수']}점
                  </div>
                </div>

                {/* 4. 특별가점 */}
                <div className="p-3.5 rounded-2xl bg-pink-50/60 border border-pink-100 flex flex-col justify-between">
                  <div className="flex items-center space-x-1 text-xs font-bold text-pink-700">
                    <span>✨</span>
                    <span>특별가점</span>
                  </div>
                  <div className={`text-lg font-black mt-2 ${breakdown['특별가점'] >= 0 ? 'text-pink-900' : 'text-rose-600'}`}>
          ...
          <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
            ...
            >
              ...
              <span>학급 응원 스탬프 ({cheerCount})</span>
            </motion.button>
